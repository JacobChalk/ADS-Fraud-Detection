...
# Flag blank means you have access to ~100MB memory on the node. Useful if you don't know how much memory your program will consume and don't want it to error.
# When you submit, if you type squeue --user <user> and see "QOSMinCpuNotSatisfied" then you need to up either nodes, ntasks-per-node or cpus-per-task
